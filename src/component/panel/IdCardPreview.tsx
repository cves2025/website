...
import { Barcode } from "./idCardDesigns";
...
// ============================================================
function ClassicCard({ person }: { person: IdCardPerson }) {
...
// ============================================================
function ModernCard({ person }: { person: IdCardPerson }) {
  const initials = initialsOf(person.name);
  return (
...
// ============================================================
function PremiumCard({ person }: { person: IdCardPerson }) {
  const initials = initialsOf(person.name);
  return (
...
// ============================================================
function VibrantCard({ person }: { person: IdCardPerson }) {
  const initials = initialsOf(person.name);
  return (
...
// Main switcher
// ============================================================
export const DESIGN_RENDERERS: Record<
  string,
  ComponentType<{ person: IdCardPerson }>
> = {
  classic: ClassicCard,
  modern: ModernCard,
  premium: PremiumCard,
