...
export const DEMO_TEACHERS: DemoTeamMember[] = [
...
export const DEMO_STAFF: DemoTeamMember[] = [
...
export const DEMO_ADMINS: DemoTeamMember[] = [
...
export const isDemo = (id: string): boolean => String(id).startsWith("demo-");