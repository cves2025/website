...
const sportsImages = import.meta.glob<string>(
  "/src/assets/image/sports/*.{jpeg,png,jpg,webp}",
  { eager: true, import: "default" },
);
const gamesImages = import.meta.glob<string>(
...
function Sports() {
  return (
    <>
      <SEO
        title="Sports Facilities | Children's Valley English School Varanasi"
        description="Children's Valley English School in Varanasi offers excellent sports facilities to promote physical fitness, teamwork, and overall student development."
      />
      <div className="flex flex-col gap-y-4 mt-4 pb-4 bg-gradient-to-b from-blue-200 to-white">
        ...
        <div className="flex flex-col items-center justify-center gap-y-8 lg:flex-row lg:gap-x-16 px-4 max-w-6xl mx-auto">
          ...
          <div className="flex flex-col items-center justify-center gap-y-4 text-xl md:text-xl text-gray-700 leading-relaxed text-center lg:text-left p-4">
            <p>
              At Children's Valley English School, we believe in nurturing not
              only the minds but also the bodies and spirits of our students.
              Our diverse range of sports and wellness activities ensures
              holistic development and encourages students to lead active,
              healthy lives.
            </p>
            <ul className="list-disc list-inside">
              <li>
                <strong>Karate:</strong> Our professionally conducted karate
                classes help students develop discipline, focus,
                self-confidence, and self-defense skills. Regular training
                sessions and belt certification programs foster both mental and
                physical strength.
              </li>
              <li>
                <strong>Dance:</strong> Dance is a joyful expression of
                creativity and rhythm. With experienced instructors, students
                explore various dance forms that enhance their coordination,
                flexibility, and confidence—all while having fun!
              </li>
              <li>
                <strong>Yoga:</strong> Our yoga sessions are designed to promote
                mindfulness, inner peace, and physical fitness. Students learn
                breathing techniques, posture control, and relaxation methods
                that contribute to their overall well-being and stress
                management. At Sun Shine Noble School, we are committed to
                providing an environment where every child can discover their
                talents, build resilience, and grow into well-rounded
                individuals.
              </li>
            </ul>
          </div>
