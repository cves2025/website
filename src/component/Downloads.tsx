...
function Downloads() {
  const pdfModules = import.meta.glob<{ default: string }>(
    "/src/assets/syllabus/*.pdf",
    { eager: true }
  );
  const timeTablesPdfModules = import.meta.glob<{ default: string }>(
    "/src/assets/timeTable/*.pdf",
    { eager: true }
  );
