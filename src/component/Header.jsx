...
const Header = () =>{
    ...
    return (
      ...
      <div className="flex overflow-hidden md:w-40 justify-center items-center">
        <img src={schoolLogo} alt="school logo" className="w-28 h-20 lg:w-auto md:h-auto" loading="lazy" />
      </div>
      <div className="flex flex-col justify-center items-center w-full">
        ...
        <p className="text-3xl font-bold text-black">Mahmoorganj Varanasi <span className="block sm:inline"><BiSolidPhoneCall className="inline mr-1" /> 9336576690</span> </p>
      </div>
    </div>
